...

{
 ...
 p3.setPlaylistName(newplaylist);
...
/**************************************************************
	...
	**************************************************************/
	...
	songDetails l = {(filename), filename};
	...
	**************************************************************/
	...
	std::vector<Song> temp = playlist.getplaylistsongs();
	...
	**************************************************************/
	...
	songDetails listOfSongs = {playlistName, (playlistName)};
